        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-white rounded-xl p-6 w-full max-w-md mx-4 my-8 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              {/* Alert moderno para comprobante faltante */}
              {showReceiptAlert && (
                <div className="alert alert-warning shadow-lg animate-pulse">
                  <div>
                    ...
                    <div>
                      <h3 className="font-bold">¡Comprobante requerido!</h3>
                      <div className="text-xs">Debes subir el comprobante de transferencia para continuar</div>
                    </div>
                  </div>
                  <div className="flex-none">
                    <button 
                      className="btn btn-sm btn-ghost" 
                      onClick={() => setShowReceiptAlert(false)}
                    >
                      ✕
                    </button>
                  </div>
                  ...
                  onClick={async () => {
                    try {
                      if (!paymentReceipt) {
                        ...
                        setTimeout(() => setShowReceiptAlert(false), 4000);
                        return;
                      }
